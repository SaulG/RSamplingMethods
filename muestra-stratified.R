...
# Box plot
pdf("output/boxplot_alldata_strata.pdf")
boxplot(sample, col = "lightblue")
dev.off()

# Histograms and density
pdf("output/histdens_alldata_strata.pdf")
par(mfrow=c(1, 4))
...
pdf("output/correlations_alldata_strata.pdf")
library(corrgram)
...
# By groups
pdf("output/histdens_bygroups_strata.pdf")
par(mfrow=c(3,3))
for (i in 1:3) {
...
pdf("output/boxplot_bygroup_strata.pdf")
par(mfrow=c(1, 3))
